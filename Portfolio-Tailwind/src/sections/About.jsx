...
export default function About(){
    return(
        ...
        <Fade triggerOnce={true} direction="up">
            <div className="flex flex-col items-center w-full reveal" id="about">
                <div className="relative min-[1800px]:w-4/5 min-[1800px]:grid-cols-3 auto-rows-[240px] grid gap-7">
